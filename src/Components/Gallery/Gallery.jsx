...
const images = [
  galler1, galler2, galler3, galler4, galler5, galler6, galler7, galler8, galler9,
  galler10, galler11, galler12, galler13, galler14, galler15, galler16, galler17,
  galler18, galler19, galler20, galler21, galler22, galler23, galler24, galler25,
  galler26, galler27, galler28, galler29, galler30,
];
  ...
  return (
    <div className="pt-32 pb-16 px-6 md:px-24 bg-white min-h-screen">
      ...
      {activeIndex !== null && (
        ...
        >
          <div
            className="relative w-full max-w-6xl flex flex-col md:flex-row gap-6"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="bg-black/70 text-gray-200 p-5 rounded-lg md:w-1/3 w-full flex flex-col justify-between">
            ...
            <div className="relative md:w-2/3 w-full flex flex-col items-center">
              <button
                className="absolute top-[-40px] md:top-[-20px] right-0 md:right-4 text-2xl md:text-3xl text-white"
                onClick={() => setActiveIndex(null)}
              >
                <FaTimes />
              </button>
              ...
              <img
                ...
                alt="Full"
                className="w-full max-h-[60vh] md:max-h-[80vh] object-contain rounded-lg shadow-xl"
              />

              <div className="mt-4 flex justify-center items-center gap-5 text-white text-xl md:text-2xl">
                <FaChevronLeft
