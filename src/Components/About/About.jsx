...
export default function About() {
  return (
    <div className="bg-[#f5f2ec] text-gray-800 pt-32 pb-16 px-4 sm:px-6 md:px-12 lg:px-24">
      <div className="text-center mb-10">
        <h1 className="text-4xl sm:text-5xl font-[Great_Vibes] text-[#a88f6b] mb-3">
          About Zilal
        </h1>
        <p className="text-xs sm:text-sm font-[Montserrat] tracking-widest uppercase text-gray-500">
          Curating Echoes of the Unseen
        </p>
      </div>

      <div className="max-w-3xl mx-auto text-[0.9rem] sm:text-sm font-[Montserrat] leading-relaxed space-y-5 text-gray-700">
        <p>
        ...
        <div className="mt-8 flex justify-center">
          <a
            href="/gallery"
            className="bg-[#a88f6b] hover:bg-[#967751] text-white px-6 py-2 text-xs sm:text-sm rounded-full tracking-widest uppercase transition duration-200"
          >
            Explore the Gallery
          </a>
        </div>
