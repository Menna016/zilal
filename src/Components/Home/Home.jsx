...
export default function HomeSection() {
    ...
    return (
        <div>
            ...
            {/* ===== Section 2: Captured Stories ===== */}
            <div className="bg-[#2f2a1f] text-white py-10 px-6 md:px-24">
                <div className="flex flex-col md:flex-row items-center justify-between gap-12">

                    {/* النص */}
                    <div className="md:w-1/2 text-left pr-0 md:pr-16">
                        <h2 className="text-4xl font-[Montserrat] font-light tracking-wide text-[#e2dac5] mb-4">
                            Welcome to ZILAL
                        </h2>
                    ...
                    <div className="md:w-1/2 relative flex justify-center">
                        <img
                            src={museum1}
                            alt="Main Museum"
                            className="w-[360px] h-[460px] object-cover shadow-lg"
                        />
                        <div className="absolute left-[-60px] top-[60px] w-[300px] h-[350px] overflow-hidden shadow-md">
                            <img
                                src={museum2}
                                alt="Overlay"
            ...
            {/* ===== Section 3: Photo Series Gallery ===== */}
            <div className="bg-white py-10 text-gray-800">
                <h2 className="text-4xl font-[Great_Vibes] text-[#a88f6b] mb-10 text-center">
                    Our Gallery
                </h2>

                {/* الصور بسكرول أفقي تبدأ من أول الصفحة */}
                <div ref={scrollRef} className="overflow-x-auto whitespace-nowrap pb-6 scrollbar-none">
                    <div className="inline-flex gap-6 pl-0 pr-6 md:pl-6">
                        {[gallery1, gallery2, gallery3, gallery4, gallery5, gallery6, gallery7, gallery8, gallery9, gallery10].map((img, i) => (
                            <img
                                key={i}
                                src={img}
                                alt={`Gallery ${i + 1}`}
                                className="w-[180px] h-[270px] object-cover rounded-xl shadow-md hover:scale-105 transition-transform duration-300"
                            />
                        ))}
                    </div>
                </div>
